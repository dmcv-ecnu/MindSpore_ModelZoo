...
class ConfigS3DIS:
    # dataset = Path('/media/test/chm/datasets/S3DIS/input_0.040')  # dataset path
    # dataset = Path('/media/T/chm/workspace/DataSet/S3DIS/''input_0.040')  # dataset path
    dataset = Path('./datasets/S3DIS/input_0.040')
    # dataset = Path('/media/niujinghao/chm/Datasets/S3DIS/input_0.040')
    # dataset = Path('/media/T/chm/workspace/DataSet/S3DIS/input_0.040') #dataset path
    # dataset = Path('/home/ubuntu/hdd1/mqh/dataset/s3dis/input_0.040') #dataset path
