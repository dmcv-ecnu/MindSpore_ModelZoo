...
def load(name: str, h_resolution: int, w_resolution: int, vision_stride_size: int, device: str = "Ascend", mode: int = 1, download_root: str = None):
    ...
    model = build_model(ckp_dict, h_resolution, w_resolution, vision_stride_size)
