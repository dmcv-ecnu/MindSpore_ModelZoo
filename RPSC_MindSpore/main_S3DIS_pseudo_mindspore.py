...
from prediction_S3DIS_score_mindspore import ModelTester
...
class S3DISDatasetGenerator:
    ...
    def load_data(self, sub_grid_size):
        ...
        for _, file_path in enumerate(self.all_files):
            ...
            if self.val_area not in cloud_name:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model_name", type=str, default="prediction_S3DIS_ana.py", help=""
    )
    parser.add_argument("--log_dir", type=str, default="ex", help="")
    parser.add_argument("--knn", type=int, default=16, help="k_nn")
    parser.add_argument("--pseudo_label_dir", type=str, default="./", help="test path")
    parser.add_argument("--last_path", type=str, default="None", help="test path")
    parser.add_argument("--total_log", type=str, default="1pt", help="")
    parser.add_argument("--weight", type=int, default=1, help="")
    ...
    cfg.pseudo_label_dir = FLAGS.pseudo_label_dir
    cfg.last_path = FLAGS.last_path
    ...
    tester = ModelTester(cfg=cfg)
    tester.test(model, dataset,test, FLAGS.weight,restore_snap=chosen_snap)
