...
class weight_ce_loss(nn.LossBase):
    """RadnLA-net with loss"""
    def __init__(self, weights, num_classes, reduction='mean'):
        super(weight_ce_loss, self).__init__(reduction)
...
if __name__ == '__main__':
    ...
    for i, data in enumerate(train_loader):
        ...
        loss, pred = network(xyz, features, neigh_idx, sub_idx, interp_idx, labels)
        print('i:',i,' loss:',loss, ' pred.shape:',pred.shape)
