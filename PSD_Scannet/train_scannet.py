...
from src.model.loss_scannet import PSDWithLoss, get_param_groups
...
if __name__ == "__main__":
    ...
    shutil.copy('train_scannet.py', str(arguments.outputs_dir))
    shutil.copy('src/model/model.py', str(arguments.outputs_dir))
    shutil.copy('src/model/loss_scannet.py', str(arguments.outputs_dir))
