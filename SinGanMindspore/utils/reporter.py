...
class Reporter(logging.Logger):
    ...
    def __init__(self, args):
        super(Reporter, self).__init__("singan-dehaze")
        self.log_dir = os.path.join(args.train_url, 'log')
        self.imgs_dir = os.path.join(args.train_url, "imgs")
        self.ckpts_dir = os.path.join(args.train_url, "ckpt")
